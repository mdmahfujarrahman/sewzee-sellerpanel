...
import ShipRocketOrderCreate from "../../components/ShipRocket/ShipRocketOrderCreate";
...
const SingleOrder = () => {
    ...
    const [ShipRocketModal, setShipRoketModal] = useState(false);
    const handleClose = () => setModalOpen(false);
    const handleShow = () => setModalOpen(true);
    const handleSRClose = () => setShipRoketModal(false);
    const handleSRShow = () => setShipRoketModal(true);
    ...
    return (
        <div className="ordersWrapper">
            ...
            />
            <ShipRocketOrderCreate
                open={ShipRocketModal}
                handleClose={handleSRClose}
            />
        </div>
    );
};
